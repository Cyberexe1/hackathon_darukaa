...
const TELEMETRY_METRICS = [
  {
    ...
    value: '+12.8%',
    unit: 'YoY',
    description: 'Verified above-ground biomass',
  },
  {
    label: 'Species Density',
    value: '+8.4%',
    unit: 'density',
    description: 'Acoustic & structural index',
  },
  {
    label: 'Canopy Stratigraphy',
    value: '+14.2%',
    unit: 'cover',
    description: 'Multi-tier crown closure',
  },
  {
    label: 'Sensor Constellation',
    value: '10m / 5-Day',
    unit: '',
    description: 'Multispectral refresh cadence',
  },
];
          ...
          <Reveal className="lg:col-span-5 flex flex-col">
            ...
            <div className="grid grid-cols-2 gap-space-md">
              {TELEMETRY_METRICS.map((metric) => (
                <div
                  key={metric.label}
                  className="p-space-md bg-surface-container-highest/5 rounded-xl"
                >
                  ...
                  <div className="font-body-sm text-label-micro text-outline-variant mt-1">
                    {metric.description}
                  </div>
                </div>
              ))}
